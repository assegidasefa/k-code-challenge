...
export const PaymentMethods = ({ onMethodSelect, selectedMethod }: PaymentMethodsProps) => {
  const [expandedMethod, setExpandedMethod] = useState<string | null>('debit-cards');


  const debitCards: PaymentMethod[] = [
    { id: 'binance-card', type: 'debit-card', name: 'Debit Card', bank: 'Binance', last4: '4578' },
    { id: 'bybit-card', type: 'credit-card', name: 'Credit Card', bank: 'ByBit', last4: '4521' },
  ];
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="border border-gray-200 rounded-lg">
        <button
          onClick={() => setExpandedMethod(expandedMethod === 'debit-cards' ? null : 'debit-cards')}
        ...
        >
          ...
          <IoIosArrowForward className={`${expandedMethod === 'debit-cards' ? 'rotate-90' : ''}`}/>
        </button>
        
        {expandedMethod === 'debit-cards' && (
          <div className="border-t border-gray-200">
            <div className="p-4 space-y-3">
              <div className="text-sm font-medium text-gray-700 mb-3">Cards List</div>
